...
function lidarLoad(item){
    ...
    // set
    $('#viewFrame').attr('src', `https://potree.entwine.io/data/${global_current_lidar}.html`)
    //load
...
function fullscreenviewer(b) {
    var win = window.open(`https://potree.entwine.io/data/${global_current_lidar}.html`, '_blank')
    win.focus();
}
